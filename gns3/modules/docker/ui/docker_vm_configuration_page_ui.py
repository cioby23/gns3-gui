...
class Ui_dockerVMConfigPageWidget(object):
    ...
    def retranslateUi(self, dockerVMConfigPageWidget):
        ...
        self.uiConsoleResolutionComboBox.setItemText(1, _translate("dockerVMConfigPageWidget", "1680x1050"))
        self.uiConsoleResolutionComboBox.setItemText(2, _translate("dockerVMConfigPageWidget", "1600x900"))
